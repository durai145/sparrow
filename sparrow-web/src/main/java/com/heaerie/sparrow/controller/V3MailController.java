...
public class V3MailController {
    ...
    public static class V3GetEmail extends Controller<MAIL001TT,MAIL001TTMapper>{
        ...
        public V3GetEmail(String id, String sendTime, String request, String status, HttpServletRequest httpServletRequest1)  {
            ...
            logger.info("V3GetEmail id={}, sendTime={}, request={}, status={}, httpServletRequest={}" , this.id, this.sendTime, this.request, this.status, httpServletRequest);
        }
    ...
    public static class V3CreateEmail extends Controller<MAIL001TT,MAIL001TTMapper>{

        String requestBody;

        public V3CreateEmail(String requestBody) {
            logger.error("V3CreateEmail().requestBody={}", requestBody);
        ...
        @Override
        public void validate() throws SparrowBadFormatException {
            logger.error("V3CreateEmail.validate");
        }

        @Override
        public MAIL001TT execute() {
            logger.error("V3CreateEmail.execute");
            HARA004TT input  = gson.fromJson(requestBody, HARA004TT.class);
            logger.error("V3CreateEmail.execute input={}",input);
    ...
    public static class V3PutEmail extends Controller<MAIL001TT,MAIL001TTMapper>{

        String requestBody;

        public V3PutEmail(String requestBody) {
            this.requestBody = requestBody;
        }
    ...
    public static class V3DeleteEmail extends Controller<MAIL001TT,MAIL001TTMapper>{

        String requestBody;

        public V3DeleteEmail(String requestBody) {
            this.requestBody = requestBody;
        }
    ...
    public Response create(String requestBody, @Context HttpHeaders httpHeaders) {
        ...
        V3CreateEmail v3CreateEmail = new V3CreateEmail(requestBody);
        return  v3CreateEmail.post();
    }
    ...
    public Response save(String requestBody, @Context HttpHeaders httpHeaders) {
        V3PutEmail v2PutEmail = new V3PutEmail(requestBody);
    ...
    public Response delete(String requestBody, @Context HttpHeaders httpHeaders) {
       V3DeleteEmail v3DeleteEmail = new V3DeleteEmail(requestBody);
       return  v3DeleteEmail.delete();
